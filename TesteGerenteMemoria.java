public class TesteGerenteMemoria {
    public static void main(String[] args) {
        ...
        System.out.println("Frames esperados: 128 | Frames calculados: " + mem.numFrames);
        ...
        int nroPalavras = 20; // Exemplo: programa com 20 palavras
        ...
        System.out.println("Alocou? " + alocou);
